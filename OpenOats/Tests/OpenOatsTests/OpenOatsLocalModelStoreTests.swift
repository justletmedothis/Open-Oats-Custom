...
final class OpenOatsLocalModelStoreTests: XCTestCase {
    ...
    func testParakeetDirectoryMigratesExistingFluidAudioCacheIntoStableStore() throws {
        ...
        let sourceDirectory = fluidAudioRoot.appendingPathComponent(Repo.parakeetV3.folderName, isDirectory: true)
    ...
    func testClearModelCacheRemovesStableAndLegacyLocations() throws {
        ...
        let legacyParakeet = fluidAudioRoot.appendingPathComponent(Repo.parakeetV3.name, isDirectory: true)
